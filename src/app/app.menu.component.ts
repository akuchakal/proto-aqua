...
export class AppMenuComponent implements OnInit {
    ...
    ngOnInit() {
        this.model = [
            {label: 'State', icon: 'fa fa-fw fa-home', routerLink: ['/']},
            {label: 'Evaluations', icon: 'fa fa-fw fa-check', routerLink: ['/sample/evaluations']},
            {label: 'Timeline', icon: 'fa fa-fw fa-calendar', routerLink: ['/sample/timeline']},
            {label: 'Contact', icon: 'fa fa-fw fa-id-card', routerLink: ['/sample/contact']},
        ];
    }
